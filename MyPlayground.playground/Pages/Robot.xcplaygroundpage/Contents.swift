    ...
    mutating func getRelativeMovement(operations: String) -> Movement {
        ...
        for operation in operations {
            ...
            switch Operation(rawValue: operation) {
                case .P:
                    polymorphMove(MovementForward(), movementDirection: position.movementDirection, position: &position)
                    break
                case .L:
                    polymorphMove(TurnCounterClockWise(), movementDirection: position.movementDirection, position: &position)
                    break
                case .D:
                    polymorphMove(TurnClockwise(), movementDirection: position.movementDirection, position: &position)
                    break
                default:
                    break
            }
